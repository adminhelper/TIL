...
* [HTTP](README.md)
  * [1. HTTP의 이해](repository/http/1.-http.md)
  * [2. HTTP Client](repository/http/2.-http-client.md)
  * [3. HTTP Server](repository/http/3.-http-server.md)
  * [4. Java HTTP Server](repository/http/4.-java-http-server.md)

## 📔 REST API

* [REST API](database/note/2week/README.md)
...
* [DTO & JSON & CORS](dto-and-json-and-cors/dto-and-json-and-cors/README.md)
  * [1. DTO(Data Transfer Object)](dto-and-json-and-cors/dto-and-json-and-cors/1.-dto-data-transfer-object.md)
  * [2. 직렬화(Serialization)](dto-and-json-and-cors/dto-and-json-and-cors/2.-serialization.md)
  * [3. JSON](dto-and-json-and-cors/dto-and-json-and-cors/3.-json.md)
...
* [jpa](jpa/jpa/README.md)
  * [ORM(Object-Relational Mapping)](jpa/jpa/orm-object-relational-mapping.md)
  * [JPA(Jakarta Persistence API)](jpa/jpa/jpa-jakarta-persistence-api.md)
  * [Hibernate](jpa/jpa/hibernate.md)
  * [Embedable](jpa/jpa/embedable.md)
  * [RelationShop Mapping](jpa/jpa/relationshop-mapping/README.md)
    * [N + 1 문제](jpa/jpa/relationshop-mapping/n-+-1.md)
    * [DDD Aggregate](jpa/jpa/relationshop-mapping/ddd-aggregate.md)
    * [CascadeType.ALL](jpa/jpa/relationshop-mapping/cascadetype.all.md)
    * [orphanRemoval](jpa/jpa/relationshop-mapping/orphanremoval.md)
    * [Event Sourcing](jpa/jpa/relationshop-mapping/event-sourcing.md)
    * [@OneToMany와 @JoinColumn](jpa/jpa/relationshop-mapping/onetomany-joincolumn.md)
  * [Spring Data JPA](jpa/jpa/spring-data-jpa/README.md)
